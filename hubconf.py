...
def checkpoint_from_distributed(state_dict):
    ...
    GPU inference.  :param state_dict: model's state dict """
    ret = False
...
def nvidia_tacotron_stft():
    from PyTorch.SpeechSynthesis.Tacotron2.common.layers import TacotronSTFT
    # copy-pasted from https://github.com/NVIDIA/waveglow
    config = {
